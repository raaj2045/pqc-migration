...
var (
	...
	fd_Params_sig_verify_cost_mldsa     protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Params_sig_verify_cost_mldsa = md_Params.Fields().ByName("sig_verify_cost_mldsa")
}
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.SigVerifyCostMldsa != uint64(0) {
		value := protoreflect.ValueOfUint64(x.SigVerifyCostMldsa)
		if !f(fd_Params_sig_verify_cost_mldsa, value) {
			return
		}
	}
}
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.auth.v1beta1.Params.sig_verify_cost_mldsa":
		return x.SigVerifyCostMldsa != uint64(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Params) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.auth.v1beta1.Params.sig_verify_cost_mldsa":
		x.SigVerifyCostMldsa = value.Uint()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.auth.v1beta1.Params"))
		}
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.auth.v1beta1.Params.sig_verify_cost_mldsa":
		panic(fmt.Errorf("field sig_verify_cost_mldsa of message cosmos.auth.v1beta1.Params is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.auth.v1beta1.Params"))
		}
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.SigVerifyCostMldsa != 0 {
			n += 1 + runtime.Sov(uint64(x.SigVerifyCostMldsa))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.SigVerifyCostMldsa != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.SigVerifyCostMldsa))
			i--
			dAtA[i] = 0x30
		}
		if x.SigVerifyCostSecp256K1 != 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 6:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field SigVerifyCostMldsa", wireType)
				}
				x.SigVerifyCostMldsa = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.SigVerifyCostMldsa |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *Params) GetSigVerifyCostMldsa() uint64 {
	if x != nil {
		return x.SigVerifyCostMldsa
	}
	return 0
}
...
var file_cosmos_auth_v1beta1_auth_proto_rawDesc = []byte{
	...
	0x6c, 0x22, 0xa2, 0x03, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x2e, 0x0a, 0x13,
	...
	0x65, 0x63, 0x70, 0x32, 0x35, 0x36, 0x6b, 0x31, 0x12, 0x49, 0x0a, 0x15, 0x73, 0x69, 0x67, 0x5f,
	0x76, 0x65, 0x72, 0x69, 0x66, 0x79, 0x5f, 0x63, 0x6f, 0x73, 0x74, 0x5f, 0x6d, 0x6c, 0x64, 0x73,
	0x61, 0x18, 0x06, 0x20, 0x01, 0x28, 0x04, 0x42, 0x16, 0xe2, 0xde, 0x1f, 0x12, 0x53, 0x69, 0x67,
	0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x43, 0x6f, 0x73, 0x74, 0x4d, 0x6c, 0x64, 0x73, 0x61, 0x52,
	0x12, 0x73, 0x69, 0x67, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x43, 0x6f, 0x73, 0x74, 0x4d, 0x6c,
	0x64, 0x73, 0x61, 0x3a, 0x21, 0xe8, 0xa0, 0x1f, 0x01, 0x8a, 0xe7, 0xb0, 0x2a, 0x18, 0x63, 0x6f,
