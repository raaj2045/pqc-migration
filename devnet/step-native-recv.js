...
// it (SetDenom/SetDenomMetadata) and mints a new ibc/<hash> voucher to USER —
// no pre-registration needed on the Cosmos side.
//
...
(async () => {
  ...
  const out = execFileSync(txCmd,
    [...txArgs, env.file("msg-native-recv.json"), env.RELAYER_KEY, "3000000"],
    { encoding: "utf8" });
