...
NOTE: unlike the original module, this port does not gate Mint on a
bridge_authority address — any signer can currently submit MsgMint. A
proof-verification gate is planned for a later phase.`,
...
standard flow is:
  ...
  2. Submit via 'pqchaind tx gov submit-proposal <file>'.
  3. Deposit and vote.
